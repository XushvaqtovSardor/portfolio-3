    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center bg-black text-white px-4 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col mt-12 sm:flex-row justify-center gap-5 reveal-up reveal-delay-3">
                    <button
                        onClick={() => scrollToSection('about')}
                        className="inline-flex items-center justify-center min-w-[190px] mt-11 px-12 py-4 bg-white text-black rounded-full font-mono text-base font-semibold hover:opacity-90 transition-opacity duration-300"
                    >
                        View My Work ↓
                    </button>
                    <button
                        onClick={() => scrollToSection('projects')}
                        className="inline-flex items-center justify-center min-w-[190px] mt-11 px-12 py-4 border border-white/30 text-white rounded-full font-mono text-base hover:border-white hover:bg-white/5 transition-colors duration-300"
                    >
                        Contact Me
                    </button>
                </div>
